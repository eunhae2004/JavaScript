...
// floor(): 소수점 첫번째 자리에서 소수점을 버린다
console.log(Math.floor(10.49)); // 10
console.log(Math.floor(10.5)); // 10.5
console.log(Math.floor(-10.5)); // -11  (소숫점을 버리면 숫자는 작아지므로)
console.log(Math.floor(-10.51)); // -11

// ceil(): 소수점 첫번째 자리에서 소수점을 올린다
...
console.log(Math.floor(r * 10)); // 0 ~ 9
